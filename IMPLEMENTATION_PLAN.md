...
Group 1 (Foundation) and Group 2 (App Shell) are complete. Group 3 (Copii Tab) is complete.
Work continues on Group 4 (Medicamente Tab) and Group 5 (Program Tab).
...
- [x] **3.3 Delete child with confirmation**
...
- [x] **3.4 Per-child medication toggles**
